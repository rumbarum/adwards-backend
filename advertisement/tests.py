...
class AdvertisementTest(TestCase):
    ...
    def test_get_advertisement_list_by_condition(self):
        ...
        response = c.get(
            "/user/advertisements?offset=0&limit=1",
        ...
        response = c.post(
            "/user/advertisements?offset=0&limit=1&tag=개발3",
             **{"HTTP_Authorization": Authorization_user,"content_type":"application/json"}
        ) 
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
        ...
        response = c.post(
            "/user/advertisements?offset=0&limit=1&category_id=6",
            **{"HTTP_Authorization": Authorization_user,"content_type":"application/json"}
        )
        ...
        test1 = {
            "order_by": [{"field":"price_per_view", "asc":True}]
        }
        response = c.post(
            "/user/advertisements?offset=0&limit=1", 
            json.dumps(test1),
        ...
        test2 = {
            "order_by":[{"field":"like_count", "asc":False}]
        }
        response = c.post(
            "/user/advertisements?offset=0&limit=1", 
            json.dumps(test2),
    ...
    def test_advetiser_advertisement(self):
        ...
        response = c.post(
            "/advertiser/advertisementdetail/1", 
            json.dumps(test3), 
            **{"content_type":"application/json", "HTTP_Authorization":Authorization_advertiser}
        )
